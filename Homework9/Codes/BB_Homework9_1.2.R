...
Rev=ggplot(data1, aes(x=Period, y=Revenue)) +
  ...
  theme_classic()
ggsave(paste0("C:/Users/BABlanchard/OneDrive - LSU AgCenter/Documents/grad semester 7/EXST 7087/Time_Series_Analysis/Homework9/Results/",data1$Date[nrow(data1)],"/Revenue.jpg"),width=10,heigh=10,Rev)
...
write.csv(RMSE,paste0("C:/Users/BABlanchard/OneDrive - LSU AgCenter/Documents/grad semester 7/EXST 7087/Time_Series_Analysis/Homework9/Results/",data1$Date[nrow(data1)],"/Smoothed_7_RMSE_days_",k,"_revenue.csv"))
