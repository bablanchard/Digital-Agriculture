...
write.csv(data1,"C:/Users/BABlanchard/OneDrive - LSU AgCenter/Documents/grad semester 7/EXST 7087/Time_Series_Analysis/Homework9/Data/Cleandata1.csv")
data1$Period <- as.Date(data1$Period, format = "%m.%d.%Y")
dir.create(paste0("C:/Users/BABlanchard/OneDrive - LSU AgCenter/Documents/grad semester 7/EXST 7087/Time_Series_Analysis/Homework9/Results/",data1$Date[nrow(data1)]),showWarnings = F)
...
Rev=ggplot(data1, aes(x=Period, y=Revenue)) +
  ...
  theme_classic()
ggsave(paste0("C:/Users/BABlanchard/OneDrive - LSU AgCenter/Documents/grad semester 7/EXST 7087/Time_Series_Analysis/Homework9/Results/",data1$Date[nrow(data1)],"/Revenue.jpg"),width=10,heigh=10,p1)

#===================== Creating moving averages and adding them to the dataset ============
StrtDay=data1$Period[1]
y_m_d=as.numeric(strsplit(as.character(StartDay),"-")[[1]])
...
write.csv(SumStats,paste0("C:/Users/BABlanchard/OneDrive - LSU AgCenter/Documents/grad semester 7/EXST 7087/Time_Series_Analysis/Homework9/Results/",data1$Date[nrow(data1)],"/Summary_Statistics.csv"))
write.csv(data1,"C:/Users/BABlanchard/OneDrive - LSU AgCenter/Documents/grad semester 7/EXST 7087/Time_Series_Analysis/Homework9/Data/Cleandata.csv")
...
ggsave(paste0("C:/Users/BABlanchard/OneDrive - LSU AgCenter/Documents/grad semester 7/EXST 7087/Time_Series_Analysis/Homework9/Results/",data1$Date[nrow(data1)],"/Predictions_vs_Test_days_",k,"_Revenue.jpg"),p1,width=10,heigh=8)
p1
...
write.csv(RMSE,paste0("C:/Users/BABlanchard/OneDrive - LSU AgCenter/Documents/grad semester 7/EXST 7087/Time_Series_Analysis/Homework9/Results/",df1$Date[nrow(df1)],"/Smoothed_7_RMSE_days_",k,"_Deaths.csv"))
...
ggsave(paste0("C:/Users/BABlanchard/OneDrive - LSU AgCenter/Documents/grad semester 7/EXST 7087/Time_Series_Analysis/Homework9/Results/",data1$Date[nrow(data1)],"/Smoothed_With_",h,"_months_prediction_Revenue.jpg"),width=12,heigh=8,p1) 
ggsave(paste0("C:/Users/BABlanchard/OneDrive - LSU AgCenter/Documents/grad semester 7/EXST 7087/Time_Series_Analysis/Homework9/Results/Latest_Smoothed_With_",h,"_months_prediction_Revenue.jpg"),width=12,heigh=8,p1) 
